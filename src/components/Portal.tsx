  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 pb-16">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <div className="bg-gradient-to-r from-emerald-800 via-teal-800 to-slate-900 rounded-2xl text-white p-6 sm:p-8 shadow-sm mb-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white mb-2">
              Portal Aplikasi Rapor Rombel Terpisah
            </h2>
            <p className="text-emerald-100 text-sm sm:text-base leading-relaxed mb-4">
              Setiap aplikasi rombel berdiri sendiri secara independen. Data siswa, nilai, capaian, dan file Excel tersimpan khusus untuk masing-masing kelas tanpa tercampur. Silakan pilih rombel Anda untuk masuk ke aplikasi kelas.
            </p>
        ...
        <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-2xs mb-8 flex flex-col md:flex-row gap-4 justify-between items-center">
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              placeholder="Cari rombel (misal: 1A, Fase B)..."
        ...
        {/* Rombel Grid grouped by grade */}
        {grades.map((gradeNum) => {
          if (filterGrade !== 'all' && filterGrade !== gradeNum) return null;
          ...
          return (
            <div key={gradeNum} className="mb-8">
        ...
        {filteredRombels.length === 0 && (
          <div className="bg-white rounded-xl p-12 text-center border border-slate-200">
            ...
            <button
              ...
              className="mt-3 px-4 py-2 bg-emerald-600 text-white rounded-lg text-xs font-medium hover:bg-emerald-700"
            >
              Reset Filter
            </button>
          </div>
